                    ...
                    <div class="row g-0 h-100">
                            ...
                            <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                ...
                                <div class="z-index-1 position-relative"><a
                                    ...
                                    <p class="opacity-75 text-white">
                                        {{ __('We will send you to verify your phone number. Provide the code below.') }}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-7 d-flex flex-center">
                            ...
                            <div class="p-4 p-md-5 flex-grow-1">
                                ...
                                @endif
                                <h3>{{ __('Enter the code to change the password') }}</h3>
                                <form id="sonoo-form" class="mt-3 mb-2" method="POST"
                                    action="{{ route('password.reset.change', ['user' => $user->id]) }}">
                                    @csrf
                                    <div class="mb-3">
                                ...
                                <a class="resend" style="pointer-events:none"
                                    href="{{ route('resend.code.password', ['user' => $user->id]) }}">{{ __('Resend Code') }}
