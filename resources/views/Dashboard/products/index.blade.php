                    ...
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        <thead class="bg-200 text-900">
                            <tr>
                                ...
                                <th class="sort pe-1 align-middle white-space-nowrap" data-sort="name">{{ __('Product Name') }}</th>
                                <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">{{ __('SKU - IDSKU - ID') }}</th>
                                <th class="sort pe-1 align-middle white-space-nowrap" data-sort="email">{{ __('Vendor Price') }}</th>
                                <th class="sort pe-1 align-middle white-space-nowrap" data-sort="email">{{ __('Price') }}</th>
                                <th class="sort pe-1 align-middle white-space-nowrap" data-sort="email">{{ __('Max Price') }}</th>
                                <th class="sort pe-1 align-middle white-space-nowrap" data-sort="email">{{ __('Quantity') }}</th>
