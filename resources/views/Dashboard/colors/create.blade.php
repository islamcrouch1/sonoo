        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Add New Color</h5>
                </div>
            </div>
        </div>
                        ...
                        <form method="POST" action="{{ route('colors.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="color_ar" class="form-control @error('color_ar') is-invalid @enderror"
                                    value="{{ old('color_ar') }}" type="text" autocomplete="on" id="color_ar" autofocus
                                    required />
                                @error('color_ar')
                            ...
                            <div class="mb-3">
                                ...
                                <input name="color_en" class="form-control @error('color_en') is-invalid @enderror"
                                    value="{{ old('color_en') }}" type="text" autocomplete="on" id="color_en" required />
                                @error('color_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div style="position: relative" class="colorpicker colorpicker-component">
                                    <input name="hex" class="form-control @error('hex') is-invalid @enderror"
                                        value="#ffffff" type="text" autocomplete="on" id="hex" required />
