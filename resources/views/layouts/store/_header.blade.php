                    ...
                    <div class="main-menu">
                        ...
                        <div class="menu-right pull-right">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        <li>
                                            <div class="mobile-back text-end">{{ __('Back') }}<i
                                                    class="fa fa-angle-{{ app()->getLocale() == 'ar' ? 'left' : 'right' }} ps-2"
                            ...
                            <div>
                                <div class="icon-nav">
                                    <ul>
                                        @if (!Route::is('store.success'))
                                            <li class="onhover-div mobile-search">
                                                <div><img src="{{ asset('assets_store/images/icon/search.png') }}"
                                                        ...
                                                        <div class="overlay-content">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-xl-12">
                                                                        {{-- <form method="GET"
                                                                        action="{{ route('store.show', ['lang' => app()->getLocale(), 'user' => $user->id]) }}">
                                                                        @csrf --}}
                                                                        <form>
                                                                            @csrf
                                        ...
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="{{ asset('assets_store/images/icon/setting.png') }}"
                                            ...
                                            <div class="show-div setting">
                                                ...
                                                <ul>
                                                    <li> <a class="nav-link"
                                                            href="{{ route('setlocale') }}">{{ __('English') }}</a>
                                                    </li>
                                                    <li> <a class="nav-link"
                                                            href="{{ route('setlocale') }}">{{ __('Arabic') }}</a>
                                                    </li>
                                                </ul>
                                                {{-- <h6>currency</h6>
