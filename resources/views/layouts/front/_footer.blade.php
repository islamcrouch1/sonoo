 ...
 <section class="bg-dark pt-8 pb-4 light">
     ...
     <div class="container">
         ...
         <div class="row">
             ...
             <div class="col-lg-6 text-center col-md-6 mt-1 ">
                 ...
                 <ul class="list-unstyled mt-0">
                     ...
                     <li>
                         <h5 class="fs-2 text-light  mb-2"> {{ __('Email') }}
                         </h5>
                         {{-- <p class="text-600  opacity-70">................</p> --}}
                         <a class="text-600  opacity-70" href="info@sonoo.online">info@sonoo.online</a>
                     </li>
                     <li>
                         <h5 class="fs-2   text-light mb-2">{{ __('Phone Number') }}
                         </h5>
                         {{-- <p class="text-600 opacity-70">....................</p> --}}
                         <a class=" text-600 opacity-70" href="tel:02-33050225">02-33050225</a>
                     </li>
                     <li>
                         <h5 class="fs-2 text-light  mb-0"> {{ __('Address') }}
                         </h5>
                         <p class="text-600 pt-2 opacity-70">
