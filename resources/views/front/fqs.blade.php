                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="collapse2" aria-labelledby="heading2"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('- We provide all the products in large quantities,In case there is a product that you can’t find on other platforms, you can message us the product’s picture on our facebook page Sonoo.online (facebook page link) and we will provide it for you as soon as possible.') }}  </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('From two to five working days, Fridays and Saturdays are off.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="collapse4" aria-labelledby="heading4"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('Each governorate has its own price, ranging from 30 EGP to 60 EGP.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading3">
                            ...
                            <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('Shipping is available in all provinces except North Sinai.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading3">
                            ...
                            <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('As a vendor, you can receive your money 7 days after the order is delivered.') }} <br>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start"> {{ __('You can add from 1% to 150% of the product price.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading3">
                            ...
                            <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('- The customer has the right to replace the product after it’s delivered within a period not exceeding 3 days.') }}<br>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('- You can simply make a new order and cancel the old order, and write in notes the reason for the replacement.') }} </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading3">
                            ...
                            <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body text-start">{{ __('-Cash: You can come to our Head Quarters and receive your profits in cash after making a request to withdraw your profits from your account.') }}<br> 
