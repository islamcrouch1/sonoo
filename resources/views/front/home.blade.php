        ...
        <div class="container ">
            <div class="row flex-center   pt-lg-8 pb-lg-9 pb-xl-0">
                <div class="col-md-11 col-lg-8 col-xl-4 pb-7  pb-xl-9 text-center text-xl-start"><a
                    ...
                    <h3 class="lead lh-base fs-2 mt-5 mb-3  text-white opacity-75">{{ __('Our first goal is for you earn and increase your profit!')}} {{ __('You are not just a normal individual, you are a person who share our goals and our ambitions') }} {{ __('and you are a') }}
                         <span class="ready typed-text  fs-3 fw-bold">{{__('success partner')}}.</span>

                    </h3>
                    <div class="wrap">
                        <button class=" mt-3 fs-4 fw-bold action">{{ __('START NOW') }}</button>

                    </div>
                    
                </div>
                <div class="col-xl-7 offset-xl-1 align-self-end mt-1 mt-xl-0"><a class="img-landing-banner rounded"
                        href="../index.html"><img class="img-fluid mb-10" src="../assets/img/generic/dashboard-altcopy.png"
                            alt="" /></a></div>
            </div>
        </div>
        <!-- end of .container-->
    ...
    <!-- <section> begin ============================-->
        <section class="py-0 pb-5 overflow-hidden light background"  id="banner">
            ...
            <div class="container  mt-7">
                <div class="row justify-content-center text-center">
                    ...
                    <h1 class=" mb-3 ncolorr fs-2 fs-sm-4 fs-md-5"><span class="tcolor">{{ __('How do you increase your income with')}}</span> <span class="fs-5 fw-bolder">{{ __('Sonoo?') }}</span>
                    </h1>
        ...
        <section class="py-0 overflow-hidden  " id="banner">
            ...
            <div class="row flex-center mt-3 ">
                <div class="col-md col-lg-5 col-xl-4 ps-lg-7 order-md-2 "><img class="  px-6 px-md-0"
                        src="../assets/img/icons/spot-illustrations/mobile.png" alt="" /></div>
                <div class="col-md col-lg-5 col-xl-4  mt-md-0">
                    <h5 class="text-warning"><span class=" fs-4 far fa-lightbulb me-2"></span><span class="fs-4">{{ __('THINK') }}</span></h5>
                    <h3 class=" fs-6  fw-bolder ncolorr">{{ __('Who is Sonoo?') }} 
                    </h3>
                    <p class=" tcolor fs-3">{{ __("We're an open market for affiliate marketers.")}} {{ __('With easy and simple transactions, we are able to deliver all of your orders to all the people,') }}  {{ __('whether you are a Seller or an Affiliate.') }}
                    </p>
                </div>
            </div>
        </section>
        ...
        {{-- @endsection --}}
            <section class="py-0 overflow-hidden  " id="banner">
                ...
                <div class="container ">
            <div class="row  flex-center ">
                <div class="col-md col-lg-5 col-xl-4 pe-lg-7 order-md-2"><img class=" px-6 px-md-0"
                        src="../assets/img/icons/spot-illustrations/cart.png" alt="" /></div>
                <div class="col-md col-lg-5 col-xl-4 mt-4 mt-md-0">
                    <h5 class="text-info"> <span class=" fs-4 ready far fa-object-ungroup me-2"></span><span class=" ready fs-4">{{ __("LET'S TRY") }}</span></h5>
                    <h3 class="fs-6  fw-bolder tcolor">{{__('How did we make it so easy?')  }} 
                    </h3>
                    <p class=" tcolor fs-3">{{ __('Your products and orders are delivered all across Egypt,')}} {{ __('with faster and safer shipping without the costing you shipping or storing.') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <section class="py-5  text-center">
            ...
            <div class="  bg-holder "
                ...
                <div class="container">
                    <div class="row">
                <div class="col">
                    <h1 class="fs-6 mt-0 pt-0  "> {{ __('YOU ARE A SUCCESSS') }}  <span class="ncolorr fs-6  fw-bolder">{{ __('PARTNER!') }}</span>
                    </h1>
                </div>
            </div>
            <div class="row mt-6">
                    ...
                    <div class="swiper-container theme-slider"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    <img class=" w-auto mx-auto"
                                        src="../assets/img/logos/b&w/4.png" alt=""height="300" />
                            ...
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    <img class=" w-auto mx-auto"
                                    src="../assets/img/logos/b&w/2.png" alt=""height="300" />
                                    <p class="  fs-sm-1 fs-md-2 fst-italic "> {{ __('Pick your product, promote it to your social media channels,')}} {{ __('choose the commission you like and leave the rest to us.') }}
                                    </p>
                            ...
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    <img class=" w-auto mx-auto"
                                    src="../assets/img/logos/b&w/5.png" alt=""height="300" />
                                    <p class=" fs-sm-1 fs-md-2 fst-italic "> {{ __('Our confirmation team, wil confirm your orders with the customer.') }}
                                    </p>
                            ...
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    <img class=" w-auto mx-auto"
                                    src="../assets/img/logos/b&w/1.png" alt=""height="300" />
                                    <p class="  fs-sm-1 fs-md-2 fst-italic "> {{ __("We'll package and deliver your orders with our fast shipping") }}.<br>
                            ...
                            <div class="swiper-slide">
                                <div class="px-5 px-sm-6">
                                    <img class=" w-auto mx-auto"
                                    src="../assets/img/logos/b&w/3.png" alt=""height="300" />
                                    <p class="fs-sm-1 fs-md-2 fst-italic ">{{ __('We collect the money and you can withdraw your earnings three working days after the product')}} 
        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-lg-6 mt-6  my-3 mt-lg-5">
                    ...
                    <h1 class="fs-6 fw-bolder text-center "> {{ __('We Will Share Success And') }} <br> <span class="fs-4 text-center first">{{ __('Increase Profits') }}</span>
                    </h1>
                ...
                <div class="col-lg-6 text-center  my-4 mt-lg-0">
                    <div class="card mt-4 card-span border  ">
                        ...
                        <div class="card-body pb-4 pt-6">
                            ...
                            <p>{{ __('It means you can buy an amount of any product you choose,')}} <br> {{ __('add it to your own inventory, and increase your profits.') }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 my-4 mt-lg-5">
                    <div class="card card-span border ">
                        ...
                        <div class="card-body px-5 pt-6 pb-4 ">
                            <h5 class=" ncolorr fs-2 fw-bold mb-2">{{ __("It's also a free marketing tool.") }} </h5>
                            <p>{{ __('Increase your sales and earn your customer’s trust with our free done for you professional online Store.')}}  {{ __('Just choose the products you want, add them to your website, and promote your landing page on all social media platforms and search engines, your orders will be registered automatically and leave the rest to us.') }} 
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 my-3  mt-lg-0">
                    <img class=" px-6 px-md-0"
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <p class="fs-6 fs-sm-4  fw-bold text-white">{{ __('Choose your products, start your AD campaigns and collect your profits.') }}
              </p>
              <div  class="wrap">
                <button class=" mt-2 fs-4 fw-bold action">{{ __('START NOW') }}</button>
